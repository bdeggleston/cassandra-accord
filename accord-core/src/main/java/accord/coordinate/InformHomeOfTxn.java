...
public class InformHomeOfTxn extends AsyncNotifiers.Settable<Void> implements Callback<SimpleReply>
{
    final TxnId txnId;
    ...
    public static AsyncNotifier<Void> inform(Node node, TxnId txnId, RoutingKey homeKey)
    {
